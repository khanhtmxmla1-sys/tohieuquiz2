...
This project is indexed by GitNexus as **itongquiz1** (6851 symbols, 18547 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/itongquiz1/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/itongquiz1/context` | Codebase overview, check index freshness |
| `gitnexus://repo/itongquiz1/clusters` | All functional areas |
| `gitnexus://repo/itongquiz1/processes` | All execution flows |
| `gitnexus://repo/itongquiz1/process/{name}` | Step-by-step execution trace |
...
Issues live in GitHub (`tongminhkhanh/itongquiz`). See `docs/agents/issue-tracker.md`.
